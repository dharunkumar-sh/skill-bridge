...
const stats = [
  ...
  { value: 5.5, prefix: "₹", suffix: "L+", label: "Avg Salary Increase", isFloat: true }
];
...
function Counter({ from = 0, to, duration = 2, isFloat = false }: CounterProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">
            Our numbers speak for themselves. We deliver measurable career outcomes.
          </p>
        </div>
          ...
          {stats.map((stat, idx) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-bold text-white mb-2 flex items-center justify-center tracking-tight">
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-indigo-400">{stat.suffix}</span>
              </div>
